...
model_urls = {
    ...
    "swinv2_small_window8_256": "https://huggingface.co/microsoft/swinv2-small-patch4-window8-256/resolve/main/pytorch_model.bin -O swinv2_small_patch4_window8_256.pth",
    "swinv2_small_window16_256": "https://huggingface.co/microsoft/swinv2-small-patch4-window16-256/resolve/main/pytorch_model.bin -O swinv2_small_patch4_window16_256.pth",
    "swinv2_base_window16_256": "./utils/pretrained/swinv2_base_patch4_window12to16_192to256_22kto1k_ft.pth",
    "swinv2_large_window16_384": "./utils/pretrained/swinv2_large_patch4_window12_192_22k.pth"
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        logit_scale = torch.clamp(self.logit_scale.cuda(), max=torch.log(torch.tensor(1. / 0.01).cuda())).exp().cuda()
...
def swin_v2(size,img_size=256,in_22k=False, **kwargs):
    if size=="swinv2_tiny_window16_256":
        ...
        if img_size!=256:
            ...
            del checkpoint["layers.3.blocks.1.attn.relative_position_index"]
        model.load_state_dict(checkpoint, strict=False)
    elif size == "swinv2_large_window16_384":
        ...
        # img_size가 384가 아닐 경우 관련된 상대 좌표 테이블 및 마스크 삭제
        if img_size != 384:
            keys_to_remove = [
                "layers.0.blocks.0.attn.relative_coords_table",
                "layers.0.blocks.0.attn.relative_position_index",
                "layers.0.blocks.1.attn_mask",
                "layers.0.blocks.1.attn.relative_coords_table",
                "layers.0.blocks.1.attn.relative_position_index",
                "layers.1.blocks.0.attn.relative_coords_table",
                "layers.1.blocks.0.attn.relative_position_index",
                "layers.1.blocks.1.attn_mask",
                "layers.1.blocks.1.attn.relative_coords_table",
                "layers.1.blocks.1.attn.relative_position_index",
                "layers.2.blocks.0.attn.relative_coords_table",
                "layers.2.blocks.0.attn.relative_position_index",
                "layers.2.blocks.1.attn_mask",
                "layers.2.blocks.1.attn.relative_coords_table",
                "layers.2.blocks.1.attn.relative_position_index",
                "layers.2.blocks.2.attn.relative_coords_table",
                "layers.2.blocks.2.attn.relative_position_index",
                "layers.2.blocks.3.attn_mask",
                "layers.2.blocks.3.attn.relative_coords_table",
                "layers.2.blocks.3.attn.relative_position_index",
                "layers.2.blocks.4.attn.relative_coords_table",
                "layers.2.blocks.4.attn.relative_position_index",
                "layers.2.blocks.5.attn_mask",
                "layers.2.blocks.5.attn.relative_coords_table",
                "layers.2.blocks.5.attn.relative_position_index",
                "layers.2.blocks.6.attn.relative_coords_table",
                "layers.2.blocks.6.attn.relative_position_index",
                "layers.2.blocks.7.attn.relative_coords_table",
                "layers.2.blocks.7.attn.relative_position_index",
                "layers.2.blocks.8.attn.relative_coords_table",
                "layers.2.blocks.8.attn.relative_position_index",
                "layers.2.blocks.9.attn.relative_coords_table",
                "layers.2.blocks.9.attn.relative_position_index",
                "layers.2.blocks.10.attn.relative_coords_table",
                "layers.2.blocks.10.attn.relative_position_index",
                "layers.2.blocks.11.attn.relative_coords_table",
                "layers.2.blocks.11.attn.relative_position_index",
                "layers.2.blocks.12.attn.relative_coords_table",
                "layers.2.blocks.12.attn.relative_position_index",
                "layers.2.blocks.13.attn.relative_coords_table",
                "layers.2.blocks.13.attn.relative_position_index",
                "layers.2.blocks.14.attn.relative_coords_table",
                "layers.2.blocks.14.attn.relative_position_index",
                "layers.2.blocks.15.attn.relative_coords_table",
                "layers.2.blocks.15.attn.relative_position_index",
                "layers.2.blocks.16.attn.relative_coords_table",
                "layers.2.blocks.16.attn.relative_position_index",
                "layers.2.blocks.17.attn.relative_coords_table",
                "layers.2.blocks.17.attn.relative_position_index",
...
class UperNet_swin(nn.Module):
    ...
    def __init__(self,size="swinv2_small_window16_256",img_size=256,num_classes=1, in_channels=3, pretrained=True):
        ...
        elif size.split("_")[1] in ["large"]:  # SwinV2-L 추가
...
class unet_swin(nn.Module):
    ...
    def __init__(
        ...
        if size.split("_")[1] in ["small","tiny"]:
            ...
            feature_channels = (3, 384, 768, 1536, 1536)
